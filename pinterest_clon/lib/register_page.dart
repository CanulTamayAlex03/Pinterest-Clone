            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  const Text(
                    'Al registrarte, aceptas las Condiciones de servicio de Pinterest y reconoces que leíste nuestra Política de privacidad. Aviso de recopilación de información.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 12,
